...
$details=$_POST['details'];
 ...
 $eid=$_GET['editid'];
    ...
    $query=mysqli_query($con, "update  tblemployee set Name='$name',TimeStart='$timestart',TimeEnd='$timeend',Gender='$gender' where ID='$eid' ");
    if ($query) {
...
<html>
<head>
<title>Update Employee - My Pedi Spa Admin</title>
...
?> 
							 ...
							 <div class="form-group"> <label for="exampleInputEmail1">Name</label> <input type="text" class="form-control" id="name" name="name"  value="<?php  echo $row['Name'];?>" required="true"> </div> <div class="form-group"> <label for="exampleInputPassword1">Time Start</label> <input type="text" id="timestart" name="timestart" class="form-control"  value="<?php  echo $row['TimeStart'];?>" required="true"> </div>
							 <div class="form-group"> <label for="exampleInputPassword1">Time End</label> <input type="text" id="timeend" name="timeend" class="form-control"  value="<?php  echo $row['TimeEnd'];?>" required="true"> </div>
